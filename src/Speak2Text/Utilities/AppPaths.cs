...
public static class AppPaths
{
    ...
    public static string CudaRuntimeDirectory => Path.Combine(EngineDirectory, "cuda");
    ...
    public static string CudaTranscribeCliPath => Path.Combine(EngineDirectory, "transcribe-cli-cuda.exe");
